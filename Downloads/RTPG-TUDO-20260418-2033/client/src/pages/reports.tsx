...
const periodOptions = [
  { value: "dia", label: "Dia", helper: "Hoje" },
  { value: "semana", label: "Semana", helper: "Ultimos 7 dias" },
  { value: "mes", label: "Mes", helper: "Mes atual" },
  { value: "ano", label: "Ano", helper: "Ano atual" }
];
      ...
      <div className="card">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-bold">Escolha a visao financeira</h2>
            <p className="mt-1 text-sm text-muted">
              Os cards, a DRE geral e a DRE por produto recalculam automaticamente para o periodo selecionado.
            </p>
          </div>
        ...
        <div className="mt-4 rounded-3xl p-4 surface-soft">
          <p className="text-sm text-muted">
            Periodo em analise: <strong>{formatDate(dre?.period.start)} ate {formatDate(dre?.period.end)}</strong>
          </p>
        </div>
      </div>
